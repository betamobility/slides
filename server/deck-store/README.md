...
| `GET /d/:id/assets/:name` | person | a scene asset with its stored content type, `private, max-age=3600`, `nosniff`, `content-security-policy: sandbox` |
