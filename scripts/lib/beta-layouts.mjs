...
export function betaTemplates(fragment) {
  ...
  return {
    'client-pitch': base('Client pitch', 'Client pitch', [
      ...
      S('beta-chart-text', 'evidence', { 'beta-title-h': 'What the numbers say', 'beta-col-right': 'The point the chart makes, in two sentences.', 'beta-asof': 'Data as of {{date}}' }, 'Refresh the figures at edit time and keep the as-of date.'),
    ...
    'insight-brief': base('Insight brief', 'Insight brief', [
      ...
      S('beta-chart-text', 'finding-1', { 'beta-title-h': 'The finding', 'beta-col-right': 'What the chart shows and why it matters.', 'beta-asof': 'Data as of {{date}}' }, ''),
