...
Every face in this directory is redistributed under the SIL Open Font License 1.1. The files are the latin subsets from the `@fontsource` npm packages, version 5.3.0, copied unchanged:

| File | Family | Weight | Package |
|---|---|---|---|
| `inter-latin-400-normal.woff2` | Inter | 400 | `@fontsource/inter` 5.3.0 |
| `inter-latin-700-normal.woff2` | Inter | 700 | `@fontsource/inter` 5.3.0 |
| `playfair-display-latin-700-normal.woff2` | Playfair Display | 700 | `@fontsource/playfair-display` 5.3.0 |
| `dm-mono-latin-400-normal.woff2` | DM Mono | 400 | `@fontsource/dm-mono` 5.3.0 |

The three licence texts below are the `LICENSE` files shipped in those packages, verbatim.
