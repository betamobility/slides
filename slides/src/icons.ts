...
export const ICONS = {
  ...
  // BETA FORK: Export PPTX sits beside Export PDF (plan U5).
  pptx: svg('<rect x="3" y="3" width="18" height="18" rx="2"/><path d="M7 16V8h3.5a2 2 0 0 1 0 4H7"/><path d="M14 8h3M15.5 8v8"/>'),
